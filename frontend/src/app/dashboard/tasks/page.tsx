...
import { Plus, Search, Filter, Calendar, Bell, CheckCircle2, Circle, Clock, Flag, AlertTriangle, Check, ChevronDown } from 'lucide-react';
...
const TasksPage = () => {
  ...
  const fetchTasks = async () => {
    ...
    try {
      ...
      addNotification('error', 'Error', 'Failed to load tasks. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
          ...
          <div className="px-6 py-4">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-foreground/70">Manage all your tasks in one place</p>
              </div>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="appearance-none px-3 py-2 pl-10 pr-8 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 bg-background text-foreground cursor-pointer hover:bg-accent transition-colors duration-200"
                    >
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute left-3 top-1/2 transform -translate-y-1/2 pointer-events-none">
                      <Flag className="h-4 w-4 text-foreground/60" />
                    </div>
                    <div className="absolute right-3 top-1/2 transform -translate-y-1/2 pointer-events-none">
                      <ChevronDown className="h-4 w-4 text-foreground/60" />
                    </div>
                  ...
                  {/* Sort Button */}
                  <button className="px-3 py-2 border border-border rounded-lg text-foreground hover:bg-accent flex items-center space-x-2 transition-colors duration-200">
                ...
                <div className="p-12 text-center animate-fade-in-down">
                  ...
                  {!searchTerm && filterStatus === 'all' && filterPriority === 'all' && (
                    <div className="mt-8">
                      <button
                        onClick={handleAddTask}
                        className="flex items-center space-x-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transform transition-all duration-300 hover:scale-105 mx-auto"
                      >
